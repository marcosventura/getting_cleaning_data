...
names(test)  <- gsub('mean\\.\\.', 'mean()', names(test))
names(test)  <- gsub('meanFreq\\.\\.', 'meanFreq()', names(test))
names(test)  <- gsub('std\\.\\.', 'std()', names(test))
names(train) <- gsub('mean\\.\\.', 'mean()', names(train))
names(train) <- gsub('meanFreq\\.\\.', 'meanFreq()', names(train))
names(train) <- gsub('std\\.\\.', 'std()', names(train))
